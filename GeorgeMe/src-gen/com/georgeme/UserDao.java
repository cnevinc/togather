...
public class UserDao extends AbstractDao<User, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Lantitude = new Property(3, String.class, "lantitude", false, "LANTITUDE");
    ...
    protected void bindValues(SQLiteStatement stmt, User entity) {
        ...
        String lantitude = entity.getLantitude();
        if (lantitude != null) {
            stmt.bindString(4, lantitude);
        }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // lantitude
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setLantitude(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
